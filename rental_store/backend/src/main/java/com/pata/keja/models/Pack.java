...
@Table(name = "packs", indexes = {
        @Index(name = "idx_packs_agent", columnList = "agent_id"),
        @Index(name = "idx_packs_active", columnList = "active")
})
public class Pack {
    ...
    @AttributeOverrides({
            @AttributeOverride(name = "productId", column = @Column(name = "product_id", length = 36)),
